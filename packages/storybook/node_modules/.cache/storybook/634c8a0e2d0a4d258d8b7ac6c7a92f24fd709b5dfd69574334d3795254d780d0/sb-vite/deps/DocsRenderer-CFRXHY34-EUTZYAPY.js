...
import {
  ...
  yI,
  zr
} from "./chunk-7QB6BZQI.js";
import {
  dedent
} from "./chunk-62PFLHRE.js";
import {
  require_core_events
} from "./chunk-3T3HEUF2.js";
import {
  require_client
} from "./chunk-XIZYECUL.js";
import "./chunk-KL2LSYVF.js";
import {
  gt,
  yn
} from "./chunk-Z46UB5V2.js";
import {
...
// ../../.yarn/__virtual__/@storybook-addon-docs-virtual-fbe7041249/5/.yarn/berry/cache/@storybook-addon-docs-npm-8.4.2-fd78532ce5-10c0.zip/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../.yarn/__virtual__/@storybook-blocks-virtual-648e4c3077/5/.yarn/berry/cache/@storybook-blocks-npm-8.4.2-ac02fd994d-10c0.zip/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-2WV4JYXD.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-F6OSRLHC-DDLH7SMF.js"));
...
// ../../.yarn/__virtual__/@storybook-react-dom-shim-virtual-d35368fcfc/5/.yarn/berry/cache/@storybook-react-dom-shim-npm-8.4.2-6ff3edd111-10c0.zip/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-375RUHZK.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-EUTZYAPY.js.map
